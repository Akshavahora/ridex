    ...
    {open && (
      ...
      className="fixed inset-0 z-[100] flex items-center justify-center px-4"
        >
          ...
          <button className='w-full h-11 rounded-x1 border
            ...
            {step =="login" && (
              ...
              <motion.div
                ...
                animate={{opacity:1,x:0}}>
                  ...
                  <button className='w-full h-11 rounded-xl bg-black
                  text-white font-semibold hover:bg-gray-900 transition' onClick={handleLogin}>{!loading?"Login":<CircleDashed size={18}
                  color='white' className='animate-spin'/>}</button>

                  </div>
                  <p className='mt-6 text-center text-sm text-gray-500'>
                    Don't have account? <div onClick={()=>setStep ("signup")} className='text-black
                    font-medium hover:underline'>Sign Up</div></p>
             ...
             {step =="signup" && (
              ...
              <motion.div
                ...
                animate={{opacity:1,x:0}}>
                  ...
                  disabled={loading} onClick={handleSignUp}>{!loading?"Sign Up":<CircleDashed size={18}
                  color='white' className='animate-spin'/>}</button>

                  </div>
                  <p className='mt-6 text-center text-sm text-gray-500'>
                    Already have an account? <div onClick={()=>setStep ("login")} className='text-black
                    font-medium hover:underline'>Login</div></p>

...
const VEHICLE_CATEGORIES = [
  ...
  { title: "Bikes", desc: "Fast & affordable", Icon: Bike, tag: "Quick" },
  ...
  {
    title: "Trucks",
    desc: "Heavy-duty transportation",
    Icon: Truck,
    tag: "Cargo",
  },
];
    ...
    <div className="w-full bg-white py-20 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          {/* to create slider buttons */}
          <div className="hidden sm:flex items-center gap-2">
            <motion.div
              whileTap={{ scale: 0.88 }}
              onClick={() => scroll("left")}
              className="w-11 h-11 rounded-2xl border-zinc-200 bg-white flex items-center
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    uppercase tracking-[0.18em] px-2.5 py-1.5 rounded-full mb-5
                    transition-colors"
                    >
                      <Sparkles size={8} />
                      {c.tag}

 ...
 const dispatch = useDispatch<AppDispatch>()
  ...
  return (
    <>
      ...
      >
        <div
          className="max-w-7xl mx-auto px-4 md:px-8 flex items-center
    justify-between"
        >
              ...
              return (
                <Link
                  ...
                  className={`text-sm pl-2 font-medium transition ${
                    active ? "text-white" : "text-grey-400 hover:text-white"
                  }`}
                >
                  {i}
                </Link>
                      ...
                      >
                        <div className="p-5">
                          ...
                          <button className="w-full flex items-center gap-3 py-3
                            hover:bg-gray-100 rounded-xl mt-2" onClick={handleLogout}>
                              <LogOut size={16}/>
                              Logout
                          </button>
                        </div>
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          className="fixed inset-x-0 bottom-0 bg-white rounded-t-3xl
